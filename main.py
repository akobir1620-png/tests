...
BOT_TOKEN = "8546011929:AAF1gLl0nT9dH11GdcFBYbmLPYpmSEshga0"  # O'z tokeningizni yozing
bot = telebot.TeleBot(BOT_TOKEN)

# Har bir chat uchun to'xtatish holati
stop_flags = {}
    ...
    for i, item in enumerate(tests):
        ...
        try:
            ...
            bot.send_poll(
                ...
                is_anonymous=False,
                open_period=30,
                explanation=f"✅ To'g'ri javob - {item['correct'] + 1}-variant!"
            )
            count += 1
            ...
            # 31 sekund kutamiz, lekin har sekundda stop tekshiramiz
            for _ in range(31):
                if stop_flags.get(chat_id):
                    break
                time.sleep(1)
...
def test_command(message):
    ...
    # Alohida thread da ishlatamiz — bot muzlab qolmasin
